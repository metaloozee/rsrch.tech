...
export default function InputPanel({
  ...
  return (
    <div
      className={cn(
        "mx-auto h-full w-full bg-neutral-900",
        messages.length > 0
    ...
    >
      <form onSubmit={handleSubmit} className="max-w-3xl w-full mx-auto">
        <div
          className={cn(
            "relative flex flex-col w-full p-4 gap-4 border-2 border-neutral-950 drop-shadow-sm bg-black focus-within:border-neutral-900 hover:border-neutral-900 transition-all duration-200",
            messages.length > 0
